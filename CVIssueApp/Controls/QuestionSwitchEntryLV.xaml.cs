...
namespace CVIssueApp.Controls
{
	...
	public partial class QuestionSwitchEntryLV : BaseQuestionEntryTemplateLV
	{
        public static readonly BindableProperty ValueProperty = BindableProperty.Create("Value", typeof(string), typeof(QuestionSwitchEntryLV), string.Empty, BindingMode.OneWay, propertyChanged: OnValuePropertyChanged);
        public string Value
        {
        ...
        private static void OnValuePropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            {
                var control = (QuestionSwitchEntryLV)bindable;

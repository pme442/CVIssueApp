...
namespace CVIssueApp.Controls
{
    ...
    public partial class QuestionDateEntryLV : BaseQuestionEntryTemplateLV
    {
        private bool isLoaded = false;

        // In Error
        public static readonly BindableProperty InErrorProperty = BindableProperty.Create("InError", typeof(bool), typeof(QuestionDateEntryLV), false, BindingMode.Default, propertyChanged: OnInErrorPropertyChanged);
        public bool InError
        {
        ...
        {
            var control = (QuestionDateEntryLV)bindable;
            control.InError = (bool)newValue;
        }

        // Error Message
        public static readonly BindableProperty ErrorMessageProperty = BindableProperty.Create("ErrorMessage", typeof(string), typeof(QuestionDateEntryLV), string.Empty, BindingMode.Default, propertyChanged: OnErrorMessagePropertyChanged);

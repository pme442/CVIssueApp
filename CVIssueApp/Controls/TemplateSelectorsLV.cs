...
namespace CVIssueApp.Controls
{
    ...
    public class QuestionEntryTemplateSelectorLV : DataTemplateSelector
    {
        ...
        public QuestionEntryTemplateSelectorLV()
        {
            ...
            QuestionDateTemplate = new DataTemplate(typeof(QuestionDateEntryLV));
        ...
        protected override DataTemplate OnSelectTemplate(object item, BindableObject container)
        {
            ...
            switch (ControltypeProperty.GetValue(item))
            {
                ...
                case "date":
                    QuestionDateTemplate.SetValue(BaseQuestionEntryTemplateLV.ParentBindingContextProperty, container.BindingContext);
